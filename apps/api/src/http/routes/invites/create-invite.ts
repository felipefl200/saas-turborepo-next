      ...
      async (request, reply) => {
        ...
        if (cannot('create', 'Invite')) {
          throw new UnauthorizedError(
            'You do not have permission to create an invite for this organization.'
          )
        }
        ...
        if (
          ...
          throw new BadRequestError(
            `Users with the domain ${domain} are automatically attached to the organization. No need to create an invite.`
          )
        }
